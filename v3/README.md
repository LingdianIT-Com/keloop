...
+ **重要**： [v3] 使用新的开发者秘钥和签名秘钥验证身份，下单时必须传team_id，表示团队调度订单
...
| `merchants_id` | **是** | `int` | 无 | 第三方商户ID |
| `merchants_address` | **是** | `string` | 无 | 第三方商户地址 |
| `merchants_tag` | **是** | `string` | 无 | 第三方商户坐标 |
| `merchants_name` | **是** | `string` | 无 | 第三方商户名称 |
| `merchants_tel` | **是** | `string` | 无 | 第三方商户电话 |
